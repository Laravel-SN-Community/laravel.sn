<x-guest-layout>
    <x-authentication-card>
        ...
        <div class="mt-6">
            ...
            <div class="mt-6">
                <a href="{{ route('auth.github') }}" class="w-full inline-flex justify-center items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors duration-200">
