<div class=" ">
    <!-- Hero Section -->
    <x-section class="mx-auto max-w-3xl py-16 sm:pt-32 lg:pb-20 lg:pt-40 min-h-screen">
        <div class="text-center">
            {{-- <img src="{{ asset('images/Laravelsn.jpg') }}" alt="Laravel Senegal"
                class="mx-auto h-24 w-24 rounded-full object-cover mb-8 shadow-lg"> --}}
            <h1 class="font-heading text-4xl font-semibold tracking-tight text-[#E11C2E] sm:leading-none lg:text-6xl">
                {{ __('global.site_name') }}
            </h1>
            <p class="mt-3 text-base text-gray-700  sm:mt-5 sm:text-lg">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="bg-gray-50 p-6 rounded-lg">
                    ...
                    <p class="text-gray-600 mb-6">
                        Participez à nos discussions, partagez vos projets et apprenez avec d'autres développeurs
                        Laravel au Sénégal.
                    </p>
                    <div class="space-y-3">
                        <a href="https://chat.whatsapp.com/JwITxALLv0uJIGNu7AsVnx"
