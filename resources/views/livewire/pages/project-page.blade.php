                    ...
                    @foreach($projects as $project)
                        <div class="bg-white rounded-xl border py-2 px-4 hover:border-red-600 transition-colors">
                            <div class="flex gap-6">
                                ...
                                <!-- Right Side: Fire Icon with Count -->
                                <div class="flex items-center gap-2 md:flex-shrink-0">
                                    <button disabled class="flex items-center gap-2 border border-gray-300 px-4 py-2 rounded-lg font-semibold hover:border-red-600 transition-colors">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
