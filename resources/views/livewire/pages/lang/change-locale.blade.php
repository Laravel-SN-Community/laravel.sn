<div class="relative" x-data="{ open: false }" x-on:click.away="open = false">
    ...
    {{-- Dropdown menu --}}
    <div
        class="absolute right-0 bottom-full mb-2 z-[60] w-24 origin-bottom-right rounded-xl bg-white shadow-xl ring-1 ring-gray-900/5 focus:outline-none overflow-hidden md:bottom-auto md:top-full md:mt-2 md:mb-0"
        role="menu"
    ...
    >
        <div class="py-1">
            @foreach($this->availableLocales as $locale)
                <button
                    type="button"
                    wire:click="setLocale('{{ $locale['code'] }}')"
                ...
                >
                    ...
                    @if($locale['code'] === $this->currentLocale)
                        <svg class="ml-auto h-4 w-4 text-red-600" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
