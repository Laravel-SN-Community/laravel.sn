<button type="button"
    class="group inline-flex text-sm px-3 py-1.5 rounded-md bg-white/10 items-center gap-2 text-gray-300 hover:text-white cursor-pointer"
    wire:click="changeLocale">
    @if ($this->currentLocale !== 'fr')
        <svg viewBox="0 0 640 480" class="size-5 rounded">
            <path fill="#097720" d="M0 0h213.3v480H0z" />
            <path fill="#FEDA3E" d="M213.3 0h213.4v480H213.3z" />
            <path fill="#E11C2E" d="M426.7 0H640v480H426.7z" />
            <g fill="#097720" transform="translate(320 240)scale(7.1111)">
                <g id="cm-b">
    ...
    @else
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" class="size-5 rounded">
