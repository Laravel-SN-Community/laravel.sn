    ...
    <div class="flex h-16 items-center justify-between max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" x-data="{ open: false }"
        ...
        {{-- <div class="bg-red-600 text-white text-center py-2 px-4">
            <div class="max-w-7xl mx-auto flex items-center justify-center space-x-2">
                <span class="text-xl font-medium">🎉 Senegal PHP & Laravel Event, samedi 1 novembre 2025 au Orange Digital
                    Center</span>
                <a wire:navigate href="{{ route('event.show', 2) }}" class="inline-flex items-center hover:underline"
                    title="Visitez Laravel.sn">
